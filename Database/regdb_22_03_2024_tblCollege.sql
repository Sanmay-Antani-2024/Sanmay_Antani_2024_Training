...
CREATE TABLE `tblCollege` (
  ...
  PRIMARY KEY (`applID`,`degree`),
  CONSTRAINT `tblCollege_ibfk_1` FOREIGN KEY (`applID`) REFERENCES `tblApplicantMaster` (`applID`),
  CONSTRAINT `tblCollege_chk_1` CHECK ((`degree` in (_utf8mb4'B',_utf8mb4'M')))
...
-- Dump completed on 2024-03-27 18:55:52
